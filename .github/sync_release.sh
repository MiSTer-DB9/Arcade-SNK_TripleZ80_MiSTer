...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-SNK_TripleZ80_MiSTer.git"
CORE_NAME=(Arcade-SNK_TripleZ80)
...
UPSTREAM_CORE_NAME=(Arcade-SNK_TripleZ80)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-SNK_TripleZ80.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-SNK_TripleZ80.rbf)
